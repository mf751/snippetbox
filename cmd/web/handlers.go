...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "Snippet was succussfully created!")
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Email), "emial", "This field cannot be blank")
	form.CheckField(
		validator.Matches(form.Email, validator.EmailRX),
		"email",
		"This field must be a vaild email address",
	)
	form.CheckField(validator.NotBlank(form.Password), "password", "This field cannot be balnk")
	form.CheckField(
	...
	app.sessionManager.Put(r.Context(), "flash", "Your signup was succussful. Please log in.")
...
func (app *application) changePasswordPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(
		validator.MinChars(form.CurrentPassword, 8),
		"currentPassword",
		"This field cannot be less than 8 charactors long",
	)
	form.CheckField(
	...
	form.CheckField(
		validator.MinChars(form.ConfirmNewPassword, 8),
		"confirmNewPassword",
		"This field cannot be less than 8 charactors long",
	)
	form.CheckField(
		...
		"confirmNewPassword",
		"This field must be the same as the new password",
	)
	...
	app.sessionManager.Put(r.Context(), "flash", "Password changes succussfully!")
	http.Redirect(w, r, "/", http.StatusSeeOther)
}
