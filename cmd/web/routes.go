...
func (app *application) routes() http.Handler {
	...
	router.Handler(http.MethodGet, "/user/login", dynamic.ThenFunc(app.userSignup))
	router.Handler(http.MethodPost, "/user/login", dynamic.ThenFunc(app.userSignup))
	router.Handler(http.MethodPost, "/user/logout", dynamic.ThenFunc(app.userSignup))
